...
df_asc = read_asc_file('dbfs:/mnt/import/ohi_flatfile_bsa_testomgeving/Maatwerk_3333_20230501_20230531_OHIMZ_513.ASC')
display(df_asc)
...
df_asc = spark.read \
    .option("header", False) \
    .option("inferSchema",True) \
    .text('dbfs:/mnt/import/ohi_flatfile_bsa_testomgeving/Maatwerk_3333_20230501_20230531_OHIMZ_513.ASC')
