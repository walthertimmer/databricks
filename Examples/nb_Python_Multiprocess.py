...
tables_to_count = [
    ...
    ,("hive_metastore","10_bronze_api_cbs","generatiecodes")
    ,("hive_metastore","10_bronze_api_cbs","leeftijdcodes")
    ,("hive_metastore","10_bronze_api_cbs","geslachtcodes")
    ,("hive_metastore","10_bronze_api_cbs","margescodes")
    ,("hive_metastore","10_bronze_api_cbs","onderwijssoortcodes")
    ,
]
