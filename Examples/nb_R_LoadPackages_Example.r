...
.libPaths(c(.libPaths(), "/Volumes/ndp_consumable/00_system/init_scripts/R/libs"))
...
folder_path <- "/dbfs/Volumes/ndp_consumable/00_system/init_scripts_r/R/libs/"
...
package_path <- "/Volumes/ndp_consumable/00_system/init_scripts/R/libs/janitor"
...
# Specify the path to the package file on the volume
package_path <- "/Volumes/ndp_consumable/00_system/init_scripts/R/libs/janitor_2.1.0.tar.gz"
